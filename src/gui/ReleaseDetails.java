...
public class ReleaseDetails extends javax.swing.JFrame{
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][]{},
            new String [] {
                "ID", "Title", "Language", "Status", "Formats", "Release date", "Track-count"
            }
        ));
    ...
    private static void AddRows(){
        ...
        for (int i=0; i<releases.size(); i++){
            rowdata[0]=releases.get(i).getID();
            rowdata[1]=releases.get(i).getTitle();
            rowdata[2]=releases.get(i).getLanguage();
            rowdata[3]=releases.get(i).getStatus();
            rowdata[4]=releases.get(i).getFormat();
            rowdata[5]=releases.get(i).getReleaseDate();
            if (releases.get(i).getTrackCount()!=-1) rowdata[6]=releases.get(i).getTrackCount();
            else rowdata[6]=null;
